...
w, loss = imp.mean_squared_error_gd(
    y_train, x_train_cleaned, np.zeros(x_train_cleaned.shape[1]), 200, 0.1
)
...
w_, loss_ = imp.mean_squared_error_sgd(
    y_train, x_train_cleaned, np.zeros(x_train_cleaned.shape[1]), 100, 0.1
)
